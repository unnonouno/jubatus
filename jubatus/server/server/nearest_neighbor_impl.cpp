// This file is auto-generated from nearest_neighbor.idl(0.4.5-347-g86989a6) with jenerator version 0.5.2-19-gd01989b/user-error
// *** DO NOT EDIT ***
...
class nearest_neighbor_impl : public jubatus::server::common::mprpc::rpc_server {
 public:
  explicit nearest_neighbor_impl(
    ...
    rpc_server::add("neighbor_row_from_data", jubatus::util::lang::bind(
        &nearest_neighbor_impl::neighbor_row_from_data, this,
        jubatus::util::lang::_1));
    rpc_server::add("similar_row_from_id", jubatus::util::lang::bind(
        &nearest_neighbor_impl::similar_row_from_id, this,
        jubatus::util::lang::_1));
    rpc_server::add("similar_row_from_data", jubatus::util::lang::bind(
        &nearest_neighbor_impl::similar_row_from_data, this,
        jubatus::util::lang::_1));
  ...
  void neighbor_row_from_data(msgpack::rpc::request& req) {
    msgpack::type::tuple<std::string, jubatus::core::fv_converter::datum,
        uint32_t> params;
    req.params().convert(&params);
    JRLOCK_(p_);
    std::vector<std::pair<std::string, float> > retval = get_p(
        )->neighbor_row_from_data(params.get<1>(), params.get<2>());
    req.result(retval);
  }
  ...
  void similar_row_from_data(msgpack::rpc::request& req) {
    msgpack::type::tuple<std::string, jubatus::core::fv_converter::datum,
        int32_t> params;
    req.params().convert(&params);
    JRLOCK_(p_);
    std::vector<std::pair<std::string, float> > retval = get_p(
        )->similar_row_from_data(params.get<1>(), params.get<2>());
    req.result(retval);
  }
